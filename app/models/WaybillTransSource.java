 ...
 * @author mdpinar
*/
public class WaybillTransSource extends BaseModel {

	private static final long serialVersionUID = 1L;
	private static final Right RIGHT = Right.IRSL_IRSALIYE_KAYNAKLARI;
	...
	public static List<WaybillTransSource> page() {
		return ModelHelper.page(RIGHT, "name");
	}

	public static WaybillTransSource findById(Integer id) {
