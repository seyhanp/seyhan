 ...
 * @author mdpinar
*/
public class StockDepot extends BaseModel {

	private static final long serialVersionUID = 1L;
	private static final Right RIGHT = Right.STOK_DEPO_TANITIMI;
	...
	public static List<StockDepot> page() {
		return ModelHelper.page(RIGHT, "name");
	}

	public static StockDepot findById(Integer id) {
