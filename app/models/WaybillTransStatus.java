 ...
 * @author mdpinar
*/
public class WaybillTransStatus extends BaseModel {

	private static final long serialVersionUID = 1L;
	private static final Right RIGHT = Right.IRSL_IRSALIYE_DURUMLARI;
	...
	@ManyToOne
	public WaybillTransStatus parent;
	...
	public static List<WaybillTransStatus> page() {
		return ModelHelper.orderedPage(RIGHT, ORDERING);
	}

	public static WaybillTransStatus findById(Integer id) {
