 ...
 * @author mdpinar
*/
public class ContactTransSource extends BaseModel {

	private static final long serialVersionUID = 1L;
	private static final Right RIGHT = Right.CARI_ISLEM_KAYNAKLARI;
	...
	public static List<ContactTransSource> page() {
		return ModelHelper.page(RIGHT, "name");
	}

	public static ContactTransSource findById(Integer id) {
	...
	public static Map<String, String> crossOptions(String direction) {
		if (direction != null) {
			...
			if (tt != null) {
				if (tt.equals(TransType.Debt)) return options(Right.CARI_BORC_DEKONTU);
				if (tt.equals(TransType.Credit)) return options(Right.CARI_ALACAK_DEKONTU);
			}
		}
		return options(null);
	}
