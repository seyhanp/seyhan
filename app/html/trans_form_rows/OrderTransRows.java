 ...
 * @author mdpinar
*/
public class OrderTransRows {

	public static String build(OrderTrans orderTrans) {
		StringBuilder row = new StringBuilder();

		List<OrderTransDetail> details = orderTrans.details;
		if (details.size() == 0) details.add(new OrderTransDetail());
