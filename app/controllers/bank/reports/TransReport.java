...
import views.html.banks.reports.trans_report;
...
public class TransReport extends Controller {
	...
	private final static Right RIGHT_SCOPE = Right.BANK_HAREKET_RAPORU;
	...
	public static class Parameter {
		...
		public static Map<String, String> reportTypes() {
			...
			options.put("Account", Messages.get("report.type.account_based"));
	...
	public static Result generate() {
		...
		if(filledForm.hasErrors()) {
			...
			if (params.reportType.equals("Account")) {
				field = "b.name";
