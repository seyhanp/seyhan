...
import views.html.contacts.reports.last_trans_report;
...
public class LastTransReport extends Controller {
	...
	private final static Right RIGHT_SCOPE = Right.CARI_SON_ISLEM_RAPORU;
	...
	private static String getQueryStringPart2(Parameter params) {
		...
		if (params.transType != null) {
			queryBuilder.append(" and t.trans_type = '");
	...
	public static Result generate() {
		...
		if(filledForm.hasErrors()) {
			...
			return ReportService.sendReport(repPar, repRes, last_trans_report.render(filledForm));
		}
