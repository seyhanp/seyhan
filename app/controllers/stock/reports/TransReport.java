...
import views.html.stocks.reports.trans_report;
...
public class TransReport extends Controller {
	...
	private final static Right RIGHT_SCOPE = Right.STOK_HAREKET_RAPORU;
	...
	public static Result generate() {
		...
		if(filledForm.hasErrors()) {
			...
			if (params.reportType.equals("Stock")) {
				repPar.reportName = "TransReportStockBased";
			} else {
				String label = "";
				String type = "String";
				...
				repPar.reportName = "TransReportXBased";
